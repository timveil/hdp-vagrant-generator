...
# URL of Ambari yum repo file (ex. "http://public-repo-1.hortonworks.com/ambari/centos7/2.x/updates/2.2.2.0/ambari.repo")
hdp.repo.ambari.file=http://public-repo-1.hortonworks.com/ambari/centos7/2.x/updates/2.2.2.0/ambari.repo
...
# Custom Base URL for HDP Repo (ex. "http://repo.hdp.local/hdp/centos7/HDP-2.4.2.0")
hdp.repo.base=

# Custom Base URL for HDP Utils Repo (ex. "http://repo.hdp.local/hdp/centos7/HDP-UTILS-1.1.0.20")
hdp.repo.utils.base=

# API URL to create custom HDP Repo (ex. "http://${vm.fqdn}:8080/api/v1/stacks/HDP/versions/2.4/operating_systems/redhat7/repositories/HDP-2.4")
hdp.ambari.api.repositories.hdp.url=

# API URL to create custom HDP Utils Repo (ex. "http://${vm.fqdn}:8080/api/v1/stacks/HDP/versions/2.4/operating_systems/redhat7/repositories/HDP-UTILS-1.1.0.20")
...
# Vagrantfile generated by https://github.com/timveil/hdp-vagrant-generator on 6/20/16 10:13 PM
...
echo " "
echo "---------------------------------------------------------------------------------------------------------------"
echo "----- Executing PUT to Create HDP Repo"
echo "---------------------------------------------------------------------------------------------------------------"
echo " "

curl --silent --show-error -H "X-Requested-By: ambari" -X PUT -d '{"Repositories": {"base_url": "","verify_base_url": false}}' -u admin:admin 

echo " "
echo "---------------------------------------------------------------------------------------------------------------"
echo "----- Executing PUT to Create HDP-Utils Repo"
echo "---------------------------------------------------------------------------------------------------------------"
echo " "
